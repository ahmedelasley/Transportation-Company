                    ...
                    <div class="mb-3 mb-xl-0 z-3">
                        <div class="btn-group dropdown">
                            ...
                            <select class="form-control rounded" wire:model.live="sortBy">
                                ...
                                @forelse (\Schema::getColumnListing('clients')  as $row)
                ...
                <div class="card col-md-12">
                            ...
                            <table class="table table-striped table-striped-columns table-hover table-bordered border-primary table-sm text-center">
                                <thead class="bg-primary sticky-top" style="z-index: 0;">
                                    <tr>
                                        ...
                                        <th class="wd-10p"><h6><b>{{ __('Phone') }}</b></h6></th>
                                        <th class="wd-10p"><h6><b>{{ __('Area') }}</b></h6></th>
                                        <th class="wd-10p"><h6><b>{{ __('Know US') }}</b></h6></th>
                                        <th class="wd-10p"><h6><b>{{ __('Category') }}</b></h6></th>
                                        <th class="wd-5p"><h6><b>{{ __('Status') }}</b></h6></th>
                                ...
                                <tbody class="table-group-divider tx-14 tx-bold">
                                    ...
                                    <tr>
                                        ...
                                        <td> <a class="" href="" data-toggle="modal" data-target="#showModal" wire:click.prevent='getForm({{ $value->id }})'><i class="fa fa-user"></i> {{ $value->name }} </a></td>
                                        <td> <a class="" href="" data-toggle="modal" data-target="#showPhonesModal" wire:click.prevent='getForm({{ $value->id }})'><i class="fa fa-phone"></i> {{ $value->phone_number }} </a></td>
                                        <td> {{ $value->area->name }} </td>
                                        <td> {{ $value->social->name }} </td>
                                        ...
                                        <td> {{ $value->date }} </td>
                                        <td>
                                            <a class="btn btn-warning btn-sm" href="#" data-toggle="modal" data-target="#phoneModal" wire:click.prevent='getForm({{ $value->id }})'><i class="fa fa-phone-volume"></i> </a>
                                        ...
                                        <tr>
                                            <td colspan="13">
                                                <div class="alert alert-info tx-20" role="alert">
                                                    ...
                                                    <span class="alert-inner--text"><strong> {{ __('alert.Alert') }} ! </strong> {{ __('alert.There is no data yet !', ['type' => __('alert.clients')]) }}</span>
                                                </div>    
                                            </td>
                                        </tr>
                                    @endforelse
                    ...
                    <div class="card-footer">
                        <div class="d-flex flex-row justify-content-end">
                            {{-- <div class=""> --}}
                                <ul class="pagination">
                                    {{ $clients->withQueryString()->onEachSide(5)->links() }} 
                                </ul>
                            {{-- </div> --}}
                        </div>
                    </div>
