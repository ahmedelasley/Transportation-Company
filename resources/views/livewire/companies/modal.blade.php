        ...
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-body">
                <form id="form" >
                    ...
                    <div class="form-group">
                        <label class="main-content-label h6 font-weight-bold">{{ __('Percent') }}</label>
                        <input class="form-control" type="text" name="percent" wire:model.live='form.percent' >
                        @error('form.percent')<span class="bg-danger tx-white d-block px-1 py-1">{{ $message }}</span>@enderror
                    </div>
